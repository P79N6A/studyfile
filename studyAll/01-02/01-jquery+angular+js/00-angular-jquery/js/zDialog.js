...
Dialog.prototype.create = function () {
    ...
    var DialogDivHeight = this.Height + 53 + 13 + (this.ShowButtonRow ? 40 : 0) + (this.ShowMessageRow ? 50 : 0);
  ...
  <table id="_DialogTable_' + this.ID + '" width="' + (this.Width + 26) + '" cellspacing="0" cellpadding="0" border="0" onselectstart="return false;" style="-moz-user-select: none; font-size:14px; line-height:1.4;">\
    <tr id="_Draghandle_' + this.ID + '" style="' + (this.Drag ? "cursor: move;" : "") + '">\
      <td width="13" height="53" style="background-image: url(' + IMAGESPATH + 'dialog_lt.png) !important;background: url(' + IMAGESPATH + 'dialog_lt.gif) no-repeat 0 0;"><div style="width: 13px;"></div></td>\
      <td height="53" style="background-image:url(' + IMAGESPATH + 'dialog_ct.png) !important;background: url(' + IMAGESPATH + 'dialog_ct.gif) repeat-x top;"><div style="padding: 9px 0 0 15px; float: left; font-size:16px; color:#006699;"><span id="_Title_' + this.ID + '">' + this.Title + '</span></div>\
        <div onclick="Dialog.getInstance(\'' + this.ID + '\').cancelButton.onclick.apply(Dialog.getInstance(\'' + this.ID + '\').cancelButton,[]);" onmouseout="this.style.backgroundImage=\'url(' + IMAGESPATH + 'dialog_closebtn.png)\'" onmouseover="this.style.backgroundImage=\'url(' + IMAGESPATH + 'dialog_closebtn_over.png)\'" style="margin-top:11px; margin-right:12px; position: relative; cursor: pointer; float: right; height: 16px; width: 16px; background-image: url(' + IMAGESPATH + 'dialog_closebtn.png);' + (this.ShowCloseButton ? "" : "display:none;") + '"></div></td>\
      <td width="13" height="53" style="background-image: url(' + IMAGESPATH + 'dialog_rt.png) !important;background: url(' + IMAGESPATH + 'dialog_rt.gif) no-repeat right 0;"><div style="width: 13px;"><a id="_forTab_' + this.ID + '" href="#;"></a></div></td>\
    </tr>\
    <tr valign="top">\
      ...
      <td align="center"><table width="100%" cellspacing="0" cellpadding="0" border="0" bgcolor="#ffffff">\
          ...
          <tr>\
            ...
            + (function (obj) {
                if (obj.InvokeElementId) return 'overflow-y:auto;';
            return "";
        })(this) +'">\
                <div style="position: absolute; height: 100%; width: 100%; display: none; background-color:#fff; opacity: 0.9;" id="_Covering_' + this.ID + '">&nbsp;</div>\
	' + (function (obj) {
	...
	<tr id="_ButtonRow_' + this.ID + '" style="' + (this.ShowButtonRow ? "" : "display:none") + '">\
      <td width="13" height="44" style="background-image: url(' + IMAGESPATH + 'dialog_mlm01.png) !important;background: url(' + IMAGESPATH + 'dialog_mlm01.gif) no-repeat 0 top;"></td>\
      <td height="44" aight="right" style="background-image: url(' + IMAGESPATH + 'dialog_md01.png) !important;background: url(' + IMAGESPATH + 'dialog_md01.gif) repeat-x 0 top;"><div id="_DialogButtons_' + this.ID + '" style="padding-right:12px; text-align:right;">\
		<input type="button" class="buttonStyle buttonBg" value="确 定" id="_ButtonOK_' + this.ID + '"/>\
		<input type="button" class="buttonStyle buttonBg1" value="取 消" onclick="Dialog.getInstance(\'' + this.ID + '\').close();" id="_ButtonCancel_' + this.ID + '"/>\
	  </div></td>\
      <td width="13" height="44" style="background-image: url(' + IMAGESPATH + 'dialog_mrm01.png) !important;background: url(' + IMAGESPATH + 'dialog_mrm01.gif) no-repeat right top;"><a onfocus=\'$id("_forTab_' + this.ID + '").focus();\' href="#;"></a></td>\
    </tr>\
	<tr>\
...
Dialog.getBgdiv = function () {
    ...
    if (!bgdiv) {
		...
		var bgIframeMask = '<div id="_DialogBGMask" style="position:absolute;background-color:#000;opacity:0.9;filter:alpha(opacity=90);width:100%;height:100%;"></div>';
...
Dialog.alert = function (msg, func, w, h) {
    ...
    diag.InnerHtml = '<table height="100%" border="0" align="center" cellpadding="0" cellspacing="0">\
		<tr><td align="right"><img id="Icon_' + this.ID + '" src="' + IMAGESPATH + 'icon_alert.png" width="34" height="34" align="absmiddle"></td>\
			<td align="left" id="Message_' + this.ID + '" style="padding-left:15px; font-size:14px">' + msg + '</td></tr>\
	</table>';
    diag.show();
...
Dialog.confirm = function (msg, funcOK, funcCal, okBtnVal, cancelBtnVal, w, h) {
    var w = w || 300,
        h = h || 110;
    var diag = new Dialog({
        Width: w,
    ...
    diag.show();
    diag.okButton.parentNode.style.textAlign = "center";
    diag.okButton.value = okBtnVal || "确 定";
    diag.cancelButton.value = cancelBtnVal || "取 消";
    diag.okButton.focus();
};
