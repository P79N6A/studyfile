	并发编程实践中，'ConcurrentHashMap'是一个经常被使用的数据结构，'相比'于'Hashtable'以及'Collections.synchronizedMap()'，
ConcurrentHashMap'在线程安全'的基础上'提供了更好的写并发能力'，但同时'降低了对读一致性的要求'（这点好像CAP理论啊 O(∩_∩)O）。
