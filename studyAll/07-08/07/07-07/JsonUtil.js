package com.zte.ecc.secret.action;
...
public class JsonUtil {
	 ...
	 * @throws SQLException
	 */
	public EccCustPersonInfoDev copyBeanValue(
			CustomersPersonBaseInfoForm customersPersonBaseInfoForm)
			throws SQLException {
		EccCustPersonInfoDev eccCustPersonInfoDev = new EccCustPersonInfoDev();
		// 数据赋值
		eccCustPersonInfoDev.setPersonType(Integer
				.valueOf(customersPersonBaseInfoForm.getPersonType()));
		eccCustPersonInfoDev.setCustomerId(Integer
				.valueOf(customersPersonBaseInfoForm.getCustomerId()));
		eccCustPersonInfoDev.setCustomerDeptId(Integer
				.valueOf(customersPersonBaseInfoForm.getCustomerDeptId()));
		eccCustPersonInfoDev.setName(customersPersonBaseInfoForm.getName());
		eccCustPersonInfoDev.setLinkmanType(customersPersonBaseInfoForm
				.getLinkManType());
		eccCustPersonInfoDev.setLevel(customersPersonBaseInfoForm.getLevel());
		eccCustPersonInfoDev.setEmail(customersPersonBaseInfoForm.getEmail());
		eccCustPersonInfoDev.setTitle(customersPersonBaseInfoForm.getTitle());
		eccCustPersonInfoDev.setOfficePhone(customersPersonBaseInfoForm
				.getOfficePhone());
		eccCustPersonInfoDev
				.setCommunicationAddress(customersPersonBaseInfoForm
						.getCommunicationAdress());
		eccCustPersonInfoDev.setPostCode(customersPersonBaseInfoForm
				.getPostCode());
		eccCustPersonInfoDev.setHomePhone(customersPersonBaseInfoForm
				.getHomePhone());
		eccCustPersonInfoDev.setMobilePhone(customersPersonBaseInfoForm
				.getMobilePhone());
		if (null != customersPersonBaseInfoForm.getBirthday1()) {
			eccCustPersonInfoDev.setBirthday(customersPersonBaseInfoForm
					.getBirthday1());
		}
		if (null != customersPersonBaseInfoForm.getBirthday2()) {
			eccCustPersonInfoDev.setBirthday(customersPersonBaseInfoForm
					.getBirthday2());
		}
		eccCustPersonInfoDev.setSex(customersPersonBaseInfoForm.getSex());
		eccCustPersonInfoDev.setFaith(customersPersonBaseInfoForm.getFaith());
		eccCustPersonInfoDev.setLanguage(customersPersonBaseInfoForm
				.getLanguage());
		eccCustPersonInfoDev.setMarriage(customersPersonBaseInfoForm
				.getMarriage());
		eccCustPersonInfoDev.setIdcode(customersPersonBaseInfoForm.getIdCode());
		// 其它个人基本信息
		eccCustPersonInfoDev.setHealth(customersPersonBaseInfoForm.getHealth());
		eccCustPersonInfoDev.setPassport(customersPersonBaseInfoForm
				.getPassport());
		eccCustPersonInfoDev.setNowaddr(customersPersonBaseInfoForm
				.getNowAddr());
		eccCustPersonInfoDev.setPostCode1(customersPersonBaseInfoForm
				.getPostCode1());
		eccCustPersonInfoDev.setCareerAim(customersPersonBaseInfoForm
				.getCareerAim());
		eccCustPersonInfoDev.setId(Sequence
				.getNextValue("ECC_CUST.ECC_CUST_PERSON_INFO_S"));
		return eccCustPersonInfoDev;
	}
