'微信网页授权'
如果'用户'在微信'客户端'中'访问第三方网页'，'公众号'可以'通过微信网页授权'机制，
来'获取用户'基本'信息'，进而'实现业务逻辑'。

关于'网页授权''回调域名'的说明
1、在'微信公众号''请求'用户'网页授权'之'前'，'开发者'需'要先到公众平台'官网中的
'“开发 - 接口权限 - 网页服务 - 网页帐号 - 网页授权获取用户基本信息”'的'配置选项中'，
'修改授权回调域名'。请注意，这里'填写的是域名'（是一个字符串），
而'不是URL，因此请勿加 http:// 等协议头'；
